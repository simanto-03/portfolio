...
const LOCAL_STORAGE_KEY = "unsaved_editing_project_data";

export default function EditProjects({ params }) {
    ...
    const address = `/api/project/${encodeURIComponent(title)}`;
    ...
    return (
        ...
        <div className="container mx-auto h-full py-4">
            <div className="flex justify-center items-center">
                <h1 className="text-3xl font-bold uppercase">Edit Project</h1>
            </div>
